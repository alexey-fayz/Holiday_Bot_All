...
from holiday_bot.holiday_bot.holiday.custom_holiday import MyHolidays
...
def log_calls(func):
    ...
    async def wrapper(*args, **kwargs):
        CALL_COUNTER[func.__qualname__] += 1
        count = CALL_COUNTER[func.__qualname__]
        try:
            logger.warning(
                f"▶ Запуск: {func.__qualname__} | вызов №{count}"
            )
            return await func(*args, **kwargs)
        except Exception:
            logger.exception(f"✗ Ошибка в {func.__qualname__}")
            raise
...
class RussianHolidaysBot(MyHolidays):
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        keyboard = [
            ...
            [KeyboardButton("📋 Мои праздники"), KeyboardButton("➡️ Ближайший праздник")],
    ...
    async def get_closest_official_holiday(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            await update.message.reply_text("Произошла ошибка при нахождении ближайших праздников 😕")
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        elif text in ['ближайший праздник', '➡️ ближайший праздник']:
            await self.get_closest_official_holiday(update, context)
