...
2. Создайте свою новую ветку и переключитесь на неё: `git checkout -b 15_01_mixin`
3. Если вы хотите продолжать делать следующие задания в этом же репозитории, задайте тэг `ready_15` для загрузки условий следующего подэтапа.