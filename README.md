...
2. Создайте свою новую ветку и переключитесь на неё: `git checkout -b 14_01_cls_properties`
3. Если вы хотите продолжать делать следующие задания в этом же репозитории, задайте тэг `ready_14` для загрузки условий следующего подэтапа.
