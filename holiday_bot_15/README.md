...
2. Создайте свою новую ветку и переключитесь на неё: `git checkout -b 16_01_private_method`
3. Если вы хотите продолжать делать следующие задания в этом же репозитории, задайте тэг `ready_16` для загрузки условий следующего подэтапа.